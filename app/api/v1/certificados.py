...
from app.schemas.usuario import UsuarioInDB  # Importación clave que faltaba
...
@router.post("/", response_model=CertificadoInDB)
def create_certificado(
    ...
    # Verificar que el usuario sea colaborador de salud
